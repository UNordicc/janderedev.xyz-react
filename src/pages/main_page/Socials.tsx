...
const Socials: FunctionComponent = () => {
    return (
        <div className="greeting-socials">
            ...
            <SocialsEntry index={3} image="/assets/email.svg" link="mailto:unordic@unordic.me" text="unordic@unordic.me" />
            <SocialsEntry index={4} image="/assets/mastodon.svg" link="https://pol.social/@unordic" text="pol.social/@unordic" />
        </div>
    );
}
